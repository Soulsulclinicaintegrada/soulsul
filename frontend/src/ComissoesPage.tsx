    ...
    {dados ? <>
      ...
      <section className="module-panel commission-results-panel">
        ...
        <div className="commission-view-tabs">
          ...
          <button type="button" className={visualizacao === "avaliacoes" ? "active" : ""} onClick={() => { setVisualizacao("avaliacoes"); limparFiltros(); }}>Primeiras avaliações</button>
        </div>
