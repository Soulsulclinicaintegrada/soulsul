...
def test_relatorio_calcula_pagamento_misto_e_divisao_30_70():
    ...
    conn.executescript("""
        ...
        CREATE TABLE contratos (id INTEGER PRIMARY KEY, paciente_id INTEGER, valor_total REAL, forma_pagamento TEXT, plano_pagamento_json TEXT, status TEXT, data_aprovacao TEXT, data_criacao TEXT, data_pagamento_entrada TEXT);
