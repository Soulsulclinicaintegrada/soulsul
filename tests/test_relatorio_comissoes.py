...
def test_relatorio_calcula_pagamento_misto_e_divisao_30_70():
    ...
    conn.executescript("""
        ...
        CREATE TABLE agendamentos (id INTEGER PRIMARY KEY, data TEXT, hora_inicio TEXT, paciente_id INTEGER, paciente_nome TEXT, profissional TEXT, procedimento TEXT, status TEXT, data_criacao TEXT, nome_paciente_snapshot TEXT, data_agendamento TEXT, criado_por TEXT, status_usuario TEXT, criado_em TEXT, comissao_agendador TEXT);
